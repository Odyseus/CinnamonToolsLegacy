...
menu_actions = {}
schema = "org.cinnamon.extensions.0CinnamonMaximusForkByOdyseus@domain.legacy"
schema_path = "/org/cinnamon/extensions/0CinnamonMaximusForkByOdyseus@domain.legacy/"
...
def main_menu():
    """Main menu.
    """
    print(Ansi.INFO("0CinnamonMaximusForkByOdyseus@domain.legacy"))
    print()
