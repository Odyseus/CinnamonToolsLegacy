...
menu_actions = {}
schema = "org.cinnamon.extensions.0WindowDemandsAttentionBehavior@domain.legacy"
schema_path = "/org/cinnamon/extensions/0WindowDemandsAttentionBehavior@domain.legacy/"
schema_filename = "%s.gschema.xml" % schema
schema_storage = "/usr/share/glib-2.0/schemas/"
xlet_has_schema = False
...
def main_menu():
    """Main menu.
    """
    print(Ansi.INFO("0WindowDemandsAttentionBehavior@domain.legacy"))
    print()
