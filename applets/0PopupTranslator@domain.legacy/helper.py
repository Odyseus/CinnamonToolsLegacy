...
menu_actions = {}
schema = "org.cinnamon.applets.0PopupTranslator@domain.legacy"
schema_path = "/org/cinnamon/applets/0PopupTranslator@domain.legacy/"
...
def main_menu():
    """Main menu.
    """
    print(Ansi.INFO("0PopupTranslator@domain.legacy"))
    print()
