...
gettext.bindtextdomain("0PopupTranslator@domain.legacy", HOME + "/.local/share/locale")
gettext.textdomain("0PopupTranslator@domain.legacy")
_ = gettext.gettext
...
class HistoryApplication(Gtk.Application):
    ...
    def do_startup(self):
        ...
        self.filepath = os.path.join(
            HOME, ".cinnamon", "configs", "0PopupTranslator@domain.legacyHistory", "translation_history.json")
