...
gettext.bindtextdomain("0WallpaperChangerApplet@domain.legacy", os.path.expanduser("~") + "/.local/share/locale")
gettext.textdomain("0WallpaperChangerApplet@domain.legacy")
_ = gettext.gettext

# The application ID is also used as the daemon name.
APPLICATION_ID = "org.Cinnamon.Applets.WallChanger.Daemon"
SCHEMA_NAME = "org.cinnamon.applets.0WallpaperChangerApplet@domain.legacy"
SCHEMA_PATH = "/org/cinnamon/applets/0WallpaperChangerApplet@domain.legacy/"
