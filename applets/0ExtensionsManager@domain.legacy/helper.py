...
menu_actions = {}
schema = "org.cinnamon.applets.0ExtensionsManager@domain.legacy"
schema_path = "/org/cinnamon/applets/0ExtensionsManager@domain.legacy/"
...
def main_menu():
    """Main menu.
    """
    print(Ansi.INFO("0ExtensionsManager@domain.legacy"))
    print()
